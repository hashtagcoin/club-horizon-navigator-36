...
export function MapView({
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col overflow-hidden relative z-0">
      ...
      <div className="absolute bottom-20 left-[calc(50%+0.5rem)] z-50 flex items-center gap-2 bg-white/90 p-2 rounded-lg shadow-md">
        {showAllClubs ? (
